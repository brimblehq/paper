...
<Frame caption="The transfer-in modal with EPP code field and the pre-transfer checklist.">
  <img src="/images/domains/domain-transfer-in.jpeg" alt="transfer-in modal showing the EPP/auth code field, registrant email override, and the three-item pre-transfer checklist" />
</Frame>
...
<Frame caption="The EPP code reveal after 2FA confirmation.">
  <img src="/images/domains/domain-transfer-epp.jpeg" alt="transfer-out auth code reveal screen with a copy button and a "regenerate" affordance, after 2FA confirmation" />
</Frame>
...
<Frame caption="Transferring a domain between Brimble workspaces.">
  <img src="/images/domains/domain-transfer.jpeg" alt="Modal for moving a domain to another Brimble workspace" />
</Frame>

...
- [Buy a domain](/domains/buy-a-domain), register a new domain in Brimble.
- [Manage DNS records](/domains/manage-dns-records), set up records for the transferred domain.
- [Custom domains](/domains/custom-domains), attach the transferred domain to a project.

...
<Frame caption="The transfer-in modal with EPP code field and the pre-transfer checklist.">
  <img src="/images/domains/domain-transfer-in.jpg" alt="Transfer-in modal with EPP code field, registrant email override, and the pre-transfer checklist" />
</Frame>
...
<Frame caption="The EPP code reveal after 2FA confirmation.">
  <img src="/images/domains/domain-transfer-epp.jpg" alt="Transfer-out auth code reveal screen with a copy button and a regenerate affordance, after 2FA confirmation" />
</Frame>
...
<Frame caption="Transferring a domain between Brimble workspaces.">
  <img src="/images/domains/domain-transfer.jpg" alt="Modal for moving a domain to another Brimble workspace" />
</Frame>

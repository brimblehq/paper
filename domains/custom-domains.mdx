...
* A project already running at `<project-name>.brimble.app`. If you haven't deployed yet, follow the [quickstart](quickstart) first.
...
<Frame caption="The Add Domain dialog with the CNAME record to copy.">
  <img src="/images/domains/add-cname-record.jpeg" alt="Add Domain dialog showing the CNAME record Brimble expects" />
</Frame>

...
<Frame caption="DNS records table for a Brimble-managed domain.">
  <img src="/images/domains/domain-records.jpeg" alt="DNS records table for a domain, showing several record rows with type, host, value, TTL, "Proxied" toggle, and edit/delete icons" />
</Frame>

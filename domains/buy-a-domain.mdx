...
<Frame caption="Domain search results with per-TLD pricing.">
  <img src="/images/domains/purchase-domain.jpg" alt="Domain search results showing several TLD options with prices and a save-up-to-20% badge on one row" />
</Frame>
...
<Frame caption="The purchase form with duration, privacy, auto-renewal, and payment method.">
  <img src="/images/projects/buying-domain.jpg" alt="Domain purchase form showing duration, privacy, auto-renewal toggles, and the payment method selector" />
</Frame>

If you have a referral domain credit and the domain's setup price is $7 or less, Brimble applies that credit automatically and does not charge for the domain. Privacy is still charged if you turn it on. A coupon code on the purchase takes priority over the referral credit. See [Referrals](/billing/referrals).
...
To attach the domain to a project, see [Add a custom domain](/domains/custom-domains). The flow is the same as bringing a domain you already own, pick a project, optionally set up a redirect.
...
- [Add a custom domain](/domains/custom-domains), attach the domain to a project.
- [Manage DNS records](/domains/manage-dns-records), point subdomains at services.
- [Transfer a domain](/domains/transfer-a-domain), bring an existing domain into Brimble or move one out.
- [Referrals](/billing/referrals), when a domain credit is applied at checkout.

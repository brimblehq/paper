...
If you have a referral domain coupon and the domain's setup price is $7 or less, enter the coupon code at checkout for 100% off that domain. Privacy is still charged if you turn it on. See [Referrals](/billing/referrals).
...
- [Referrals](/billing/referrals), when a domain coupon is redeemed at checkout.

...
<Frame caption="Enable web analytics and copy a tracking snippet.">
  <img src="/images/analytics/tracking-snippet.jpeg" alt="Web analytics enable screen showing the tracking snippet panel with client-side and server-side tabs" />
</Frame>

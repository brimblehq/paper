...
<Frame caption="Top of the analytics view: visitors, countries, and bounce rate over the selected window.">
  <img src="/images/analytics/analytics-data-1.jpeg" alt="Web analytics overview showing visitor count, country breakdown, and bounce-rate trend" />
</Frame>

<Frame caption="Deeper breakdowns: page performance, regions, referrers, browsers, custom events, and top cities.">
  <img src="/images/analytics/analytics-data-2.jpeg" alt="Web analytics detail panels covering page performance, country and region tables, referrers, browser breakdown, custom events, and city-level visitor data" />
</Frame>

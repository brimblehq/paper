...
<CardGroup cols={3}>
  ...
  <Card title="Brimble Agent" href="/agent/overview">
    Chat in the dashboard to launch projects, read logs, and act on your workspace.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Brimble Agent" href="/agent/overview" icon="sparkles">
    In-dashboard chat: launch, debug, and act on the current workspace.
  </Card>
  ...
  <Card title="Billing" href="/billing/plans" icon="receipt">
    Plans, compute pricing, build minutes, referrals, refunds.
  </Card>
</CardGroup>

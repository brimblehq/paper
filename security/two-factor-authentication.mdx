...
description: "Add a second factor to your Brimble account."
---
...
<Frame caption="The TOTP setup screen with QR code and manual setup key.">
  <img src="/images/security/add-2fa-screen.jpg" alt="QR code for adding Brimble to a TOTP authenticator app, with the manual setup key shown below" />
</Frame>
...
<Frame caption="Verifying the 6-digit code from the authenticator app.">
  <img src="/images/security/verify-2fa-setup.jpg" alt="Verify step with a 6-digit OTP input" />
</Frame>
...
<Frame caption="Recovery codes are shown once during setup.">
  <img src="/images/security/save-recovery-code.jpg" alt="Recovery codes grid with Copy all and Download buttons and an acknowledgement checkbox" />
</Frame>
...
- [Manage teams](/workspaces-and-teams/manage-teams), invite team members and manage roles.
- [Create a workspace](/workspaces-and-teams/create-a-workspace), workspaces inherit your account's security settings.

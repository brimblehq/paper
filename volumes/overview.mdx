...
Volumes meter by GB-month while attached. Exact rates appear in the dashboard when you create a volume. See [How billing works](/billing/plans#what-else-appears-on-your-bill) for how storage shows up on invoices.

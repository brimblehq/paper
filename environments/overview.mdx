---
title: "Environments"
description: "An environment is a named set of configuration that a project deploys with."
---
...
- [Environment variables guide](/environments/environment-variables), task-oriented walkthrough.

...
See [Reference shared and cross-project variables](env-references) for the full syntax, scoping rules, and chaining behavior.
...
- [Environments concept](overview), how environments and inheritance work.
- [Reference shared and cross-project variables](env-references), the `{{shared.X}}` and `{{@slug.X}}` syntax.

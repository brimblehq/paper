...
<Frame caption="The Environment tab on a project.">
  <img src="/images/environments/add-env.jpeg" alt="Environment tab on a project showing the variables table with name, value (with eye/eye-slash toggle), environment dropdown, secret/public indicator" />
</Frame>
...
<Frame caption="Bulk-importing env variables from a .env file.">
  <img src="/images/environments/add-many-env.jpeg" alt="Bulk import modal with a textarea showing a few KEY=value lines and a comment line, plus the Import button" />
</Frame>

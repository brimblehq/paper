---
title: "DNS issues"
description: "DNS is the layer between users typing your domain name and reaching your project."
---
...
**Fix:** Use the A record value from the dashboard, or your provider's ALIAS / CNAME flattening feature. See [DNS records reference](../domains/dns-records).
...
- [Custom domains](../domains/custom-domains), full setup guide.
- [DNS records](../domains/dns-records), the supported record types and their fields.
- [TLS issues](/troubleshooting/tls), when DNS is right but the certificate is the problem.

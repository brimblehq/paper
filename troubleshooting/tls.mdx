...
description: "Brimble issues TLS certificates from Let's Encrypt automatically."
---
...
If status is **Verifying**, see [DNS issues](/troubleshooting/dns). TLS won't issue until DNS is right.
...
- [Custom domains](../domains/custom-domains), initial setup.
- [DNS issues](/troubleshooting/dns), when DNS itself is wrong.

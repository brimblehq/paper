...
<Frame caption="The notification bell in the topbar.">
  <img src="/images/getting-started/notification-bell-section.jpg" alt="Topbar with the notification bell open, showing the unread badge, several notification items with level chips, a relative timestamp on each, and the" />
</Frame>
...
<Frame caption="Notification preferences in the user profile drawer.">
  <img src="/images/getting-started/notification-preference.jpg" alt="Notifications panel in the user profile drawer showing the Push notifications toggle, Email notifications toggle, and the three webhook URL fields (Di" />
</Frame>

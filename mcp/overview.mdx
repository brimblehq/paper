...
If you want chat inside the dashboard instead, use **[Brimble Agent](/agent/overview)**. That is a signed-in assistant on `https://app.brimble.io`. MCP is for Claude, Cursor, or another client calling this server with your platform API key.

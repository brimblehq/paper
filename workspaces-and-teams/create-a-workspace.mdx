...
This guide covers creating a paid team workspace from scratch. To invite people into an existing workspace, see [Manage teams](manage-teams).
...
<Frame caption="Step 2: pick team size and concurrent build slots, with the running monthly total.">
  <img src="/images/workspaces-and-teams/workspace-creation-2.jpeg" alt="Workspace creation step 2 with team-size selector, concurrent-builds selector, optional startup promo code field, and the running monthly cost summary" />
</Frame>
...
<Frame caption="Step 3: invite teammates by email and assign each a role, with the billing summary.">
  <img src="/images/workspaces-and-teams/workspace-creation-3.jpeg" alt="Workspace creation step 3 with rows of email and role inputs, an Add another button, and the seats plus builds billing summary" />
</Frame>
...
**Want to start small.** Pick 3 seats and the minimum 2 concurrent builds, that's the floor. You can bump either later as the team grows.

## Next steps

- [Manage teams](manage-teams), invite people, change roles, transfer ownership.
- [Plans and pricing](../billing/plans), full pricing breakdown including overages.
- [Two-factor authentication](two-factor-authentication), required for ownership transfer.

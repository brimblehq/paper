...
<Frame caption="Inviting a member to a workspace.">
  <img src="/images/workspaces-and-teams/member-invitation.jpeg" alt="Members settings page showing existing members with their roles and a highlighted "Invite member" entry point that opens the invite dialog" />
</Frame>
...
- [Two-factor authentication](two-factor-authentication), required for ownership transfer and a few other sensitive actions.

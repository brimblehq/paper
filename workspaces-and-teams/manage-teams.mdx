---
title: "Manage teams"
description: "A team holds projects shared across multiple people."
---
...
<Frame caption="Inviting a member to a workspace.">
  <img src="/images/workspaces-and-teams/member-invitation.jpg" alt="Members settings page showing existing members with their roles and a highlighted Invite member entry point that opens the invite dialog" />
</Frame>
...
Each team has its own billing. Charges on a team apply to projects under that team.

- **Team plan.** **$11 per seat per month**, plus metered usage. Team workspaces get the **same allowances as Developer** (bandwidth, builds, concurrency, features). See [How billing works](/billing/plans) and [Compute pricing](/billing/compute).
- Personal **Hacker** and **Developer** plans stay on your personal workspace; they do not cover team projects.

A user can be in many teams, each with its own subscription. Personal projects are billed separately.
...
- [Two-factor authentication](/security/two-factor-authentication), required for ownership transfer and a few other sensitive actions.

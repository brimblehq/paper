...
<Frame caption="Inviting a member to a workspace.">
  <img src="/images/workspaces-and-teams/member-invitation.jpeg" alt="Members settings page showing existing members with their roles and a highlightedInvite member entry point that opens the invite dialog" />
</Frame>

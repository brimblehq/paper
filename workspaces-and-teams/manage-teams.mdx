...
- **Team plan.** **$11 per seat per month**, plus metered usage (compute, bandwidth overage, storage, and so on). See [How billing works](/billing/plans) and [Compute pricing](/billing/compute).

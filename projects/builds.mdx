...
* **Paid plans:** overage bills at the per-minute rate from [How billing works](/billing/plans) and rolls into the next invoice. You can also top up; see [Build minutes](../billing/build-minutes).

...
description: "If a new deployment breaks production, roll back to a previous one."
---
...
<Frame caption="Deployment history with the redeploy action open.">
  <img src="/images/projects/log-redeploy.jpg" alt="Deployment history page showing several deployment rows with status chips, commit messages, branches, deployer avatars, timestamps, and the row-level" />
</Frame>
...
- [Deployments](/projects/deployments), full lifecycle and what each state means.
- [Build failures](../troubleshooting/build-failures), diagnose why the new deployment broke.

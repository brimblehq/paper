...
<Frame caption="Live deployment logs stream by phase as the build runs.">
  <img src="/images/projects/build-logs-pipeline-section.jpeg" alt="live deployment logs drawer streaming output, with phase headers (Clone, Detect, Install, Build, Push, Deploy) collapsible, status chip showing "In pr…" />
</Frame>

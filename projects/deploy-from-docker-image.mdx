...
<Frame caption="The Docker source step, image reference and registry credentials.">
  <img src="/images/projects/deploy-docker-first-page.jpeg" alt="New-project flow with Docker image selected and registry credentials expanded" />
</Frame>

<Frame caption="The Docker source step, runtime configuration.">
  <img src="/images/projects/deploy-docker-second-page.jpeg" alt="Second page of the Docker deploy flow showing service type, region, and compute size" />
</Frame>

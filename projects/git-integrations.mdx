...
PR previews are gated by plan, see [How billing works](/billing/plans).
...
**PR opened but no preview deployment.** PR previews are plan-gated. Confirm your plan allows them; see [How billing works](/billing/plans). Also confirm the PR targets the tracked branch.

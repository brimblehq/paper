...
<Frame caption="Persistent disk configuration on a project.">
  <img src="/images/projects/persistent-disk-section.png" alt="the Persistent disk panel under **Configuration**, showing the toggle on, a mount-path input set to `/data`, and the size dropdown listing the 10–150…" />
</Frame>

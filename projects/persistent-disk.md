...
{% hint style="info" %}
**Image needed:** the Persistent disk panel under **Configuration**, showing the toggle on, a mount-path input set to `/data`, and the size dropdown listing the 10–150 GB options with prices alongside each entry.
{% endhint %}
...
* [Builds](builds.md), for how the runtime container is built and started.

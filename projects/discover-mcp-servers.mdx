...
<Frame caption="The MCP server marketplace.">
  <img src="/images/projects/mcp-marketplace.jpeg" alt="Discover page showing a grid of MCP server cards with category filter tabs and a search input at the top" />
</Frame>

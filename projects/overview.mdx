...
See [Deploy a database](deploy-a-database) for the full list of versions and sizing options.
...
<Frame caption="The Projects list summarises each project's current state.">
  <img src="/images/projects/projects-list.jpeg" alt="Projects list view in the dashboard, showing a few project cards with status chips, framework logos, branch labels, last commit message, deployed-by a…" />
</Frame>
...
- [Environments](environments), Production, Preview, and how env vars flow.
- [Service types reference](service-types), every service type, side-by-side.

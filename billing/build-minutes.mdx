...
<Frame caption="The Build minutes card in Billing settings.">
  <img src="/images/billing/billing-usage.jpeg" alt="Build minutes card in Billing settings showing the used/included progress bar,minutes left, reset date, top-up credits line, and the Top up butto" />
</Frame>
...
<Frame caption="Topping up build minutes.">
  <img src="/images/billing/build-minutes-topup.jpeg" alt="Top up build minutes modal showing the preset dropdown, custom amount field with $ prefix, X minutes for $Y preview line, and the Pay with •••• 4" />
</Frame>

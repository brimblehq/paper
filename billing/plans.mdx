...
**To recover at any stage**, open **Billing → Invoices**, click the open invoice, and pay it (or update the payment method first under **Billing → Payment methods**). The moment the invoice settles, projects come back online and builds re-enable.

You can hold up to three cards on file; one is the default. Cards are added through redirects to your payment provider's hosted form, Brimble never sees card numbers.

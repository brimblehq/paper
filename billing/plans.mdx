...
* **Paid plans:** overage bills at $0.002/min and rolls into the next invoice. You can also top up with credits, see [Build minutes](/billing/build-minutes).
...
* [Build minutes](/billing/build-minutes), top-ups and the included allowance.

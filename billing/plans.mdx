...
Each plan includes a monthly build-minute allowance. A build minute is wall-clock time inside the builder, from clone start to push end. See [Builds](../projects/builds) for what counts and what doesn't.

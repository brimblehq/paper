...
* **Paid plans:** overage bills at $0.002/min and rolls into the next invoice. You can also top up with credits that never expire, see [Build minutes](build-minutes).

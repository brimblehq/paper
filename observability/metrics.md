...
{% hint style="info" %}
**Image needed:** screenshot of the Observability tab on a web-service project showing two semi-gauges (CPU, Memory) at the top and a time-series chart below with tabs for Memory Usage, CPU Usage, Network Egress, and Response Times
{% endhint %}

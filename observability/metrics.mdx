...
<Frame caption="The Observability tab on a project.">
  <img src="/images/observability/cpu-memory-metrics.jpeg" alt="Observability tab on a web-service project showing two semi-gauges (CPU, Memory) at the top and a time-series chart below with tabs for Memory Usage,…" />
</Frame>
...
<Frame caption="Network Egress chart over the last hour.">
  <img src="/images/observability/network-egress.jpeg" alt="Time-series chart showing outbound network throughput in KB/s" />
</Frame>

...
Bandwidth is what's billed against your plan's allowance, see [How billing works](/billing/plans) for the limits and overage rate.
...
- [How billing works](/billing/plans), bandwidth allowance and overage.

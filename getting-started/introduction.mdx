...
description: "Brimble is a platform-as-a-service for deploying applications."
---
...
<Frame caption="The Brimble dashboard home.">
  <img src="/images/getting-started/home.jpg" alt="Brimble dashboard home showing the welcome panel, the projects-this-week stats, recent deployed projects as cards, connected domains count, and the si" />
</Frame>
...
* Teams who want bare-metal performance without operating infrastructure themselves.
* Anyone who's tired of YAML.

## Next steps

* [Quickstart →](/getting-started/quickstart), deploy your first project
* [Brimble MCP →](/mcp/overview), connect Claude or Cursor to manage Brimble
* [Add a custom domain →](../domains/custom-domains)

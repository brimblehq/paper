...
<Frame caption="Creating a project from a GitHub repository.">
  <img src="/images/getting-started/create-github-project.jpg" alt="New-project flow with a GitHub repo selected and the branch dropdown open" />
</Frame>
...
<Frame caption="Build and deploy logs streaming live in the dashboard.">
  <img src="/images/projects/build-logs-pipeline-section.jpg" alt="Deployment logs drawer showing a successful build and a green live status" />
</Frame>

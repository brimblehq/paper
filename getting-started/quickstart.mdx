...
<Frame caption="Creating a project from a GitHub repository.">
  <img src="/images/getting-started/create-github-project.jpeg" alt="new-project flow with a GitHub repo selected and the branch dropdown open" />
</Frame>
...
<Frame caption="Build and deploy logs streaming live in the dashboard.">
  <img src="/images/projects/build-logs-pipeline-section.jpeg" alt="deployment logs drawer showing a successful build and a green "live" status" />
</Frame>

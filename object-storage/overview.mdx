...
| Requests | Free during preview. |
| Egress | Free during preview. |

<Info>
  **Currently storage-only billing.** Brimble doesn't bill for request count or outbound bandwidth on object storage today. Once that changes you'll see it on your invoice with a separate line; nothing about the storage line item changes.
</Info>

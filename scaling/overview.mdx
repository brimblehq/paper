...
<Frame caption="The Scaling page with an existing scaling group.">
  <img src="/images/scaling/scaling-group-list.jpg" alt="Scaling page showing a scaling group card with the auto-scaling badge, instance count, CPU and memory threshold bars, the active toggle, and edit and delete controls" />
</Frame>
...
<Frame caption="Creating an auto-scaling group.">
  <img src="/images/scaling/create-scaling-group.jpg" alt="Create scaling group form in auto-scaling mode with the instance range slider, CPU threshold slider, and memory threshold slider visible" />
</Frame>
...
- [How billing works](../billing/plans), how extra containers show up as metered compute.

...
<Frame caption="Creating an auto-scaling group.">
  <img src="/images/scaling/create-scaling-group.jpeg" alt="Create scaling group form in auto-scaling mode with the instance range slider, CPU threshold slider, and memory threshold slider visible" />
</Frame>

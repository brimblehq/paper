...
For workloads that need custom rules (high-traffic public APIs, large file ingest), contact support. See [Rate limits](rate-limits) for the full breakdown.
...
- [Rate limits](rate-limits), full set of edge limits.
